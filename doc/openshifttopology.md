...
- [Basic ROSA Topology](#basic-rosa-topology)
...
- In Web Console, Click Home>Projects

  ![](../images/2/2-1.png)

- Click Create Project, set Name to `<username>>-lab2`, click create

  ![](../images/2/2-2.png)

- Back to Topology view, select project `<username>-lab2`

  ![](../images/2/2-3.png)

- Open Web Terminal, check current project with below command
  
  ```ssh
  oc project
  ```

- if current project is not `<username>-lab2`, change current project with below command

  ```ssh
  oc project <username>-lab2
...
- In Topology Menu, click Pod 'sise', In side panel, Resources tab, Pods section, click `(P) sise`
...
- clean up your 'sise' pod, back to web terminal in buttom frame, at command prompt call below command for clean up pod (click restart terminal if your terminal is terminated)
...
- Review Pod Configuration file (YAML), https://raw.githubusercontent.com/openshift-evangelists/kbe/main/specs/labels/pod.yaml

  ![](../images/2/2-25.png)

- Let's create a pod that initially has one label (env=development), Open Your Web Terminal and Check Current Project (same username)
...
- Review Deployment Configuration YAML : https://raw.githubusercontent.com/openshift-evangelists/kbe/main/specs/deployments/d09.yaml
...
- Review new deployment configuration yaml file : https://raw.githubusercontent.com/openshift-evangelists/kbe/main/specs/deployments/d10.yaml
...
- Review Deployment YAML, https://raw.githubusercontent.com/chatapazar/openshift-workshop/main/manifest/deployment.yaml
  
  ![](../images/2/2-20.png)

- Review Service YAML, https://raw.githubusercontent.com/chatapazar/openshift-workshop/main/manifest/svc.yaml
